...
parser.add_argument('--results_name', default='test_results.csv')
...
parser.add_argument('--json_name', default = 'full_atom_init.json')
...
def main():
    ...
    # load data
    dataset = CIFData(args.cifpath, args.json_name, args.csv_name)
